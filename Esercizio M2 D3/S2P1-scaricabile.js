...
/* SCRIVI QUI LA TUA RISPOSTA */
let totalShoppingCart = 65; // Esempio di totale carrello
...
let discount = totalShoppingCart * 0.2; // Calcolo dello sconto del 20%
let totalCost = totalShoppingCart - discount + shippingCost; // Totale da addebitare all'utente

console.log("Il totale da addebitare all'utente è: " + totalCost + " euro.");
/* ESERCIZIO EXTRA 3
